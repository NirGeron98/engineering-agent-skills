...
- Release go/no-go readiness is the task; use `.claude/skills/release-and-rollback-readiness`.
- PR correctness needs review; use `.claude/skills/code-review`.
- Product marketing release communication is needed; defer to future product skills if added.

## Composition and handoff rules

- Hand readiness decisions to `.claude/skills/release-and-rollback-readiness`.
- Hand PR review to `.claude/skills/code-review`.
- Hand implementation context summaries to `.claude/skills/handoff-documentation`.
