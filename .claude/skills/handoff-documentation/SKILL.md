...
- The target is release notes or changelog; use `.claude/skills/changelog-writer`.
- The target is onboarding documentation; use `.claude/skills/developer-onboarding-docs`.

## Composition and handoff rules

- Use after another skill has produced evidence, changes, or decisions.
- Hand release-facing summaries to `.claude/skills/changelog-writer`.
