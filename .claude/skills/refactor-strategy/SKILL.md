...
- The root cause of a bug is unknown; use `.claude/skills/diagnose-bug`.
- The request is PR review; use `.claude/skills/code-review`.
...
- Hand bug root-cause work to `.claude/skills/diagnose-bug`.
- Hand code review to `.claude/skills/code-review`.
