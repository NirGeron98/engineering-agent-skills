...
- The failure is primarily intermittent, order-dependent, seed-dependent, timing-dependent, or only fails sometimes in tests/CI — use or hand off to `.claude/skills/flaky-test-debugging`; this skill covers reproducible bugs and consistent local failures.
