...
- The task is alert threshold design; use `.claude/skills/metrics-and-alerts-review`.
- The task is deciding the source-of-truth SLOs the dashboard should reflect; use `.claude/skills/slo-definition-review`.

## Composition and handoff rules

- Defer data analysis dashboards or business reporting to future data-analysis skills.
- Defer alert threshold design to `.claude/skills/metrics-and-alerts-review`.
- Defer SLO source-of-truth decisions to `.claude/skills/slo-definition-review`.
