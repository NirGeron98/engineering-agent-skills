...
- An active incident needs coordination now; use `.claude/skills/incident-triage-runbook`.
- Release readiness or rollback safety is the main question; use `.claude/skills/release-and-rollback-readiness`.
- Kubernetes workload diagnosis is the main task; use `.claude/skills/kubernetes-workload-debugging`.

## Composition and handoff rules

- Hand active incident coordination to `.claude/skills/incident-triage-runbook`.
- Hand deployment readiness to `.claude/skills/release-and-rollback-readiness`.
- Hand Kubernetes diagnosis to `.claude/skills/kubernetes-workload-debugging`.
