...
- The refactor sequence is the main task; use `.claude/skills/refactor-strategy`.
- A bug root cause is unknown; use `.claude/skills/diagnose-bug`.
- The user needs a whole-system testing plan; use `.claude/skills/test-strategy`.

## Composition and handoff rules

- Hand refactor sequencing to `.claude/skills/refactor-strategy`.
- Hand bug diagnosis to `.claude/skills/diagnose-bug`.
- Hand broad testing plans to `.claude/skills/test-strategy`.
