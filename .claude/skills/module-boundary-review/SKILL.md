...
- The concern is a reusable frontend component API; use `.claude/skills/component-design-review`.
- The concern is runtime service behavior; use `.claude/skills/service-debugging`.
...
- Hand component-level frontend design to `.claude/skills/component-design-review`.
- Hand service behavior debugging to `.claude/skills/service-debugging`.
