...
- The task is diagnosing a specific service failure, not general log quality; use `.claude/skills/service-debugging`.
- The concern is secrets/credentials found in logs as an exposure event; use `.claude/skills/secrets-exposure-review`.
- The task is alert/metric quality, not log content; use `.claude/skills/metrics-and-alerts-review`.

## Composition and handoff rules

- Defer service debugging to `.claude/skills/service-debugging`.
- Defer security secret exposure in logs to `.claude/skills/secrets-exposure-review`.
- Defer metrics/alerts to `.claude/skills/metrics-and-alerts-review`.
