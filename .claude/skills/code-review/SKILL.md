...
- The finding is about system-level structure — module boundaries, coupling, ownership, or an architectural tradeoff — flag it and defer to `.claude/skills/architecture-review` rather than resolving it here.
