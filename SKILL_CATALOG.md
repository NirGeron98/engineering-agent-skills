...
- `repo-onboarding`
  ...
  - Path: `.claude/skills/repo-onboarding`
...
- `task-breakdown`
  ...
  - Path: `.claude/skills/task-breakdown`
...
- `diagnose-bug`
  ...
  - Path: `.claude/skills/diagnose-bug`
...
- `api-design-review`
  ...
  - Path: `.claude/skills/api-design-review`
...
- `service-debugging`
  ...
  - Path: `.claude/skills/service-debugging`
...
- `auth-flow-review`
  ...
  - Path: `.claude/skills/auth-flow-review`
...
- `background-job-queue-review`
  ...
  - Path: `.claude/skills/background-job-queue-review`
...
- `webhook-reliability-review`
  ...
  - Path: `.claude/skills/webhook-reliability-review`
...
- `idempotency-and-retry-safety-review`
  ...
  - Path: `.claude/skills/idempotency-and-retry-safety-review`
...
- `rate-limiting-and-backpressure-review`
  ...
  - Path: `.claude/skills/rate-limiting-and-backpressure-review`
...
- `component-design-review`
  ...
  - Path: `.claude/skills/component-design-review`
...
- `frontend-state-management`
  ...
  - Path: `.claude/skills/frontend-state-management`
...
- `form-validation-review`
  ...
  - Path: `.claude/skills/form-validation-review`
...
- `accessibility-review`
  ...
  - Path: `.claude/skills/accessibility-review`
...
- `rtl-ui-review`
  ...
  - Path: `.claude/skills/rtl-ui-review`
...
- `frontend-performance-review`
  ...
  - Path: `.claude/skills/frontend-performance-review`
...
- `api-integration-debugging`
  ...
  - Path: `.claude/skills/api-integration-debugging`
...
- `db-to-dwh-pipeline`
  ...
  - Path: `.claude/skills/db-to-dwh-pipeline`
...
- `dataform-bigquery-development`
  ...
  - Path: `.claude/skills/dataform-bigquery-development`
...
- `data-quality-contracts`
  ...
  - Path: `.claude/skills/data-quality-contracts`
...
- `data-freshness-investigation`
  ...
  - Path: `.claude/skills/data-freshness-investigation`
...
- `data-reconciliation-investigation`
  ...
  - Path: `.claude/skills/data-reconciliation-investigation`
...
- `backfill-planning-and-verification`
  ...
  - Path: `.claude/skills/backfill-planning-and-verification`
...
- `data-pipeline-cost-review`
  ...
  - Path: `.claude/skills/data-pipeline-cost-review`
...
- `ci-cd-debugging`
  ...
  - Path: `.claude/skills/ci-cd-debugging`
...
- `deployment-debugging`
  ...
  - Path: `.claude/skills/deployment-debugging`
...
- `terraform-plan-review`
  ...
  - Path: `.claude/skills/terraform-plan-review`
...
- `iam-permissions-debugging`
  ...
  - Path: `.claude/skills/iam-permissions-debugging`
...
- `kubernetes-workload-debugging`
  ...
  - Path: `.claude/skills/kubernetes-workload-debugging`
...
- `incident-triage-runbook`
  ...
  - Path: `.claude/skills/incident-triage-runbook`
...
- `release-and-rollback-readiness`
  ...
  - Path: `.claude/skills/release-and-rollback-readiness`
...
- `module-boundary-review`
  ...
  - Path: `.claude/skills/module-boundary-review`
...
- `dependency-and-coupling-review`
  ...
  - Path: `.claude/skills/dependency-and-coupling-review`
...
- `technical-debt-triage`
  ...
  - Path: `.claude/skills/technical-debt-triage`
...
- `refactor-strategy`
  ...
  - Path: `.claude/skills/refactor-strategy`
...
- `test-strategy`
  ...
  - Path: `.claude/skills/test-strategy`
...
- `legacy-characterization-tests`
  ...
  - Path: `.claude/skills/legacy-characterization-tests`
...
- `integration-test-design`
  ...
  - Path: `.claude/skills/integration-test-design`
...
- `e2e-test-debugging`
  ...
  - Path: `.claude/skills/e2e-test-debugging`
...
- `flaky-test-debugging`
  ...
  - Path: `.claude/skills/flaky-test-debugging`
...
- `readme-review`
  ...
  - Path: `.claude/skills/readme-review`
...
- `api-docs-review`
  ...
  - Path: `.claude/skills/api-docs-review`
...
- `runbook-writer`
  ...
  - Path: `.claude/skills/runbook-writer`
...
- `handoff-documentation`
  ...
  - Path: `.claude/skills/handoff-documentation`
...
- `changelog-writer`
  ...
  - Path: `.claude/skills/changelog-writer`
...
- `developer-onboarding-docs`
  ...
  - Path: `.claude/skills/developer-onboarding-docs`
...
- `secrets-exposure-review`
  ...
  - Path: `.claude/skills/secrets-exposure-review`
...
- `dependency-vulnerability-triage`
  ...
  - Path: `.claude/skills/dependency-vulnerability-triage`
...
- `input-validation-security-review`
  ...
  - Path: `.claude/skills/input-validation-security-review`
...
- `access-control-boundary-review`
  ...
  - Path: `.claude/skills/access-control-boundary-review`
...
- `security-incident-scoping`
  ...
  - Path: `.claude/skills/security-incident-scoping`
...
- `metrics-and-alerts-review`
  ...
  - Path: `.claude/skills/metrics-and-alerts-review`
...
- `log-signal-quality-review`
  ...
  - Path: `.claude/skills/log-signal-quality-review`
...
- `trace-based-latency-diagnosis`
  ...
  - Path: `.claude/skills/trace-based-latency-diagnosis`
...
- `slo-definition-review`
  ...
  - Path: `.claude/skills/slo-definition-review`
...
- `dashboard-signal-audit`
  ...
  - Path: `.claude/skills/dashboard-signal-audit`
...
- `query-performance-review`
  ...
  - Path: `.claude/skills/query-performance-review`
...
- `schema-migration-safety-review`
  ...
  - Path: `.claude/skills/schema-migration-safety-review`
...
- `index-strategy-review`
  ...
  - Path: `.claude/skills/index-strategy-review`
...
- `data-consistency-incident-diagnosis`
  ...
  - Path: `.claude/skills/data-consistency-incident-diagnosis`
...
- `connection-pool-and-locking-debugging`
  ...
  - Path: `.claude/skills/connection-pool-and-locking-debugging`
...
- `backup-restore-readiness`
  ...
  - Path: `.claude/skills/backup-restore-readiness`
...
- `hot-path-profiling-review`
  ...
  - Path: `.claude/skills/hot-path-profiling-review`
...
- `memory-leak-diagnosis`
  ...
  - Path: `.claude/skills/memory-leak-diagnosis`
...
- `throughput-bottleneck-triage`
  ...
  - Path: `.claude/skills/throughput-bottleneck-triage`
...
- `caching-strategy-review`
  ...
  - Path: `.claude/skills/caching-strategy-review`
...
- `load-test-result-review`
  ...
  - Path: `.claude/skills/load-test-result-review`
