...
- API contract design itself needs review; use `skills/api-and-backend/api-design-review`.
- Data pipeline architecture is the main task; use `skills/data/db-to-dwh-pipeline`.
- Browser/user-flow E2E failure is the main symptom; use `skills/testing/e2e-test-debugging`.

## Composition and handoff rules

- Hand API contract judgment to `skills/api-and-backend/api-design-review`.
- Hand data pipeline behavior to `skills/data/db-to-dwh-pipeline`.
- Hand E2E browser debugging to `skills/testing/e2e-test-debugging`.
