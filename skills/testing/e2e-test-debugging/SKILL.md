...
- The boundary is specifically frontend/API product behavior; use `skills/frontend/api-integration-debugging`.
- The proven issue is a deployed service failure; use `skills/api-and-backend/service-debugging`.
- The flake is not E2E-specific; use `skills/testing/flaky-test-debugging`.

## Composition and handoff rules

- Hand frontend/API boundary issues to `skills/frontend/api-integration-debugging`.
- Hand service runtime issues to `skills/api-and-backend/service-debugging`.
- Hand general flaky behavior to `skills/testing/flaky-test-debugging`.
