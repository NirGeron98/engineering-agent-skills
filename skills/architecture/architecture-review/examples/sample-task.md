...
The review checks the diagram against repository evidence, avoids pretending missing runtime data was inspected, and hands detailed rollout readiness to `skills/devops-infrastructure/release-and-rollback-readiness` if deployment risk becomes central.
