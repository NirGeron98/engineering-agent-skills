...
- The task is alert configuration mechanics once SLOs exist; use `skills/observability/metrics-and-alerts-review`.
- The task is dashboard panel/layout audit; use `skills/observability/dashboard-signal-audit`.
- The task is incident process design; use `skills/devops-infrastructure/incident-triage-runbook`.

## Composition and handoff rules

- Defer alert configuration mechanics to `skills/observability/metrics-and-alerts-review`.
- Defer dashboard audit to `skills/observability/dashboard-signal-audit`.
- Defer incident process to `skills/devops-infrastructure/incident-triage-runbook`.
