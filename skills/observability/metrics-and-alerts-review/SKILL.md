...
- An incident is actively in progress; use `skills/devops-infrastructure/incident-triage-runbook`.
- SLI/SLO design is the primary task; use `skills/observability/slo-definition-review`.
- Dashboard layout/panel review is the primary task; use `skills/observability/dashboard-signal-audit`.

## Composition and handoff rules

- Defer active incident handling to `skills/devops-infrastructure/incident-triage-runbook`.
- Defer SLO/SLI design to `skills/observability/slo-definition-review`.
- Defer dashboard layout/signal review to `skills/observability/dashboard-signal-audit`.
