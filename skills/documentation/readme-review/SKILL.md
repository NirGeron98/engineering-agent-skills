...
- The repo itself is not understood yet; use `skills/planning/repo-onboarding`.
- The task is new developer onboarding across many docs; use `skills/documentation/developer-onboarding-docs`.
- API reference documentation is the target; use `skills/documentation/api-docs-review`.

## Composition and handoff rules

- Hand repo exploration to `skills/planning/repo-onboarding` if the project structure is unclear.
- Hand broader onboarding documentation to `skills/documentation/developer-onboarding-docs`.
- Hand API documentation review to `skills/documentation/api-docs-review`.
