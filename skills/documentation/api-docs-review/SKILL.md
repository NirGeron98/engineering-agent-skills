...
- The API design itself needs judgment; use `skills/api-and-backend/api-design-review`.
- The task is implementation PR review; use `skills/review/code-review`.
- The README is the main target; use `skills/documentation/readme-review`.

## Composition and handoff rules

- Hand API contract design judgment to `skills/api-and-backend/api-design-review`.
- Hand implementation review to `skills/review/code-review`.
- Hand README-level docs to `skills/documentation/readme-review`.
