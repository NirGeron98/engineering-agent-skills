...
- The repo has not been explored yet; use `skills/planning/repo-onboarding`.
- The README alone is the target; use `skills/documentation/readme-review`.
- Architecture design needs review; use `skills/architecture/architecture-review`.

## Composition and handoff rules

- Hand repo understanding to `skills/planning/repo-onboarding`.
- Hand README-specific review to `skills/documentation/readme-review`.
- Hand architecture-specific review to `skills/architecture/architecture-review`.
- `skills/planning/repo-onboarding` produces a session/agent-facing technical repo map or orientation artifact focused on how the repo works; this skill produces a human-facing onboarding path for future developers, including setup, first contribution path, ownership, workflows, and contribution guidance.
