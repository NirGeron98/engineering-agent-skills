...
- An incident is actively in progress and recovery must be coordinated now; use `skills/devops-infrastructure/incident-triage-runbook`.
- The task is writing or updating the runbook document itself; use `skills/documentation/runbook-writer`.
...
- Defer operational procedure writing to `skills/documentation/runbook-writer`.
- Defer cloud infrastructure implementation to existing DevOps skills.
- Defer incident-specific recovery coordination to `skills/devops-infrastructure/incident-triage-runbook`.
